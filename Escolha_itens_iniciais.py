...
def escolher_item_inicial(dados_itens): 
	while True: 
		...
		escolha_inicial = input("Escolha entre os itens(digite o nome do item) {0}, {1} ou {2}: ".format(dados_itens,[1]["nome"],dados[2]["nome"],dados[3]["nome"]))
		if escolha_inicial == dados_itens[1]['nome']:
			...
			print(Style.DIM + "INVALIDO ESCREVA COMO MOSTRADO")
			continue			
